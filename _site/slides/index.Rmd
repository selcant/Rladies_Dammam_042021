...
After changing `eval = TRUE` and re-knitting, do you see the `test_cache` folder?
...
Click on website_ex.Rproj to start the Rstudio project.
...
Do you see "Build" next to Environment/History/Connections?

If not, go to Project Options > Build tools and choose website.
